...
<body>
	<div class="container">
		<div class="row mt-2">
		<div class="col-4">
				<form:form action="/admin/ms" method="GET" modelAttribute="filter">
					...
					<div class="form-group row">
						...
						<div class="form-group row">
							<div class="col-10 ml-auto">
								...
								<a href="/admin/ms/cancel<custom:allParams/>" class="btn btn-sm btn-outline-warning">Cancel</a>
							</div>
						</div>
				</form:form>
			</div>
					...
					<c:forEach var="ms" items="${mss.content}">
						<tr>
							...
							<td class="text-center">
								<a href="/admin/ms/update/${ms.id}<custom:allParams/>" class="btn btn-outline-warning btn-sm">Update</a>
								<a href="/admin/ms/delete/${ms.id}<custom:allParams/>" class="btn btn-outline-danger btn-sm">Delete</a>
							</td>
						</tr>
					</c:forEach>
				</table>
