...
@Component
public class IngredientUniqueValidator implements ConstraintValidator<UniqueIngredient, String>{

	private final IngredientRepository repository;

	public IngredientUniqueValidator(IngredientRepository repository) {
